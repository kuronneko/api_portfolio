...
### Description: 
Laravel API REST, capable to generate and modify a JSON with information about your portfolio profile, you can use it as a web service and consume the JSON in your static portfolio website to make dynamic it.
